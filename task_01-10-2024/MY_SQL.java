...
public class MY_SQL {
    public static void main(String[] args) {
        try (Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/college?useSSL=false&serverTimezone=Europe/Moscow", "root", "eather1192@How91")) {
            // ЗАДАНИЕ 1
